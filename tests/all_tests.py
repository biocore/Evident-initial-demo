...
"""Run all tests.
"""
#Based on the all_tests.py script from the QIIME project svn revision 3290
import re
...
from qiime.util import (parse_command_line_parameters, get_options_lookup,
                        qiime_system_call, make_option)

__author__ = "Rob Knight"
__copyright__ = "Copyright 2011-2012, Evident" #consider project name
__credits__ = ["Rob Knight","Greg Caporaso", "Jai Ram Rideout", "Yoshiki Vazquez-Baeza"] #remember to add yourself if you make changes
__license__ = "GPL"
__version__ = "0.9-dev"
